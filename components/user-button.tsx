...
export function UserButton() {
  const { isLoggedIn, setIsLoggedIn, ngoName } = useAuth()
      ...
      <DropdownMenuContent className="w-56" align="end" forceMount>
        <DropdownMenuLabel className="font-normal">
          <div className="flex flex-col space-y-1">
            <p className="text-sm font-medium leading-none">{ngoName}</p>
            <p className="text-xs leading-none text-muted-foreground">example@ngo.org</p>
          </div>
        </DropdownMenuLabel>
        <DropdownMenuSeparator />
        <DropdownMenuItem>
